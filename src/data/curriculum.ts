...
export const SUBJECTS: Subject[] = [
  ...
  // Nota: Educação Visual, Educação Musical e Ofícios foram removidas da 1ª à 4ª classe —
  // não existem como disciplinas autónomas no currículo real (PCEP 2020, INDE/MINEDH); as
  // competências estão integradas em Língua Portuguesa e Matemática no 1º Ciclo.
  ...
  // Nota: "Educação Musical" não existe como disciplina autónoma no currículo primário
  // moçambicano actual (PCEP 2020) — removida da 5ª e 6ª classe.
  ...
  { id: 'mz5-of',   gradeId: 'mz-5c', name: 'Ofícios',           shortName: 'OF',   icon: 'fa-hammer',     color: '#78716c', description: 'Marcenaria, pesca e culinária tradicional',        displayOrder: 6 },
  ...
  { id: 'mz6-of',   gradeId: 'mz-6c', name: 'Ofícios',           shortName: 'OF',   icon: 'fa-hammer',     color: '#78716c', description: 'Agro-pecuária e artesanato para o mercado local',   displayOrder: 6 },
  { id: 'mz6-ing',  gradeId: 'mz-6c', name: 'Língua Inglesa',    shortName: 'ING',  icon: 'fa-language',   color: '#7c3aed', description: 'Vocabulário básico para comunicação',               displayOrder: 7 },
  { id: 'mz6-emc',  gradeId: 'mz-6c', name: 'Ed. Moral e Cívica',shortName: 'EMC',  icon: 'fa-handshake',  color: '#64748b', description: 'Direitos, deveres e valores cívicos',               displayOrder: 8 },

  // Nota: "Educação Musical" e "Ofícios" não constam da lista oficial de disciplinas da 7ª
  // classe no currículo revisto de 2024 (INDE/MINEDH) — removidas.
  ...
  { id: 'mz7-ing',  gradeId: 'mz-7c', name: 'Língua Inglesa',    shortName: 'ING',  icon: 'fa-language',   color: '#7c3aed', description: 'Rotinas, descrições e comunicação funcional',       displayOrder: 6 },
  { id: 'mz7-emc',  gradeId: 'mz-7c', name: 'Ed. Moral e Cívica',shortName: 'EMC',  icon: 'fa-handshake',  color: '#64748b', description: 'Democracia, direitos humanos e ética',              displayOrder: 7 },
...
export const CHAPTERS: Chapter[] = [
  ...
  // ─── 5ª Classe — Educação Visual ──────────────────────────
  // Unidades 1, 2 e 4 do índice oficial de "Educação Visual e Ofícios — Livro do Aluno, 5ª Classe"
  // (MEC/IEDA, Cupane/Manjaze/Parruque/Guilossa/Augusto) — ieda.gov.mz/site/wp-content/uploads/2020/10/5aClasseEV.pdf
  { id:'mz5ev-1', subjectId:'mz5-ev', title:'Desenho e Pintura',        description:'O desenho como forma de comunicar; a pintura como acto de cobrir um espaço com cor; material para desenho e pintura; desenho livre, de observação e com tema dado; ilustração; técnicas de pintura; painéis colectivos', term:1, displayOrder:1 },
  { id:'mz5ev-2', subjectId:'mz5-ev', title:'Impressão, Estampagem, Recorte, Picotagem, Colagem e Dobragem', description:'Estampagem com carimbos; técnicas de impressão e estampagem; recorte; picotagem; colagem; dobragem', term:1, displayOrder:2 },
  { id:'mz5ev-3', subjectId:'mz5-ev', title:'Desenho Geométrico',       description:'Noção e amplitude de ângulo; medição de ângulos; elementos da circunferência; divisão de circunferências e construção de figuras planas — triângulo equilátero, quadrado e hexágono; identificação de formas geométricas na natureza', term:2, displayOrder:3 },

  // ─── 5ª Classe — Ofícios ───────────────────────────────────
  // Unidades 3, 5 e 6 do mesmo índice oficial (5ª Classe, Educação Visual e Ofícios).
  // Nota: "Educação Musical" não existe como disciplina autónoma no currículo primário
  // moçambicano actual (PCEP 2020) — mz5-em fica sem capítulos.
  { id:'mz5of-1', subjectId:'mz5-of', title:'Modelagem e Moldagem',     description:'Origem e propriedades de materiais moldáveis (barro); ferramentas usadas na modelagem e moldagem; técnicas de modelagem; reprodução em série; técnicas de transformação do papel; técnicas de decoração e acabamento', term:2, displayOrder:1 },
  { id:'mz5of-2', subjectId:'mz5-of', title:'Têxteis',                  description:'Tipos de materiais têxteis; construção do tear de cartão; bordados; pontos de tecelagem; tranças', term:3, displayOrder:2 },
  { id:'mz5of-3', subjectId:'mz5-of', title:'Construções',              description:'Instrumentos musicais; objectos lúdicos com desperdícios de madeira e metal; ferramentas simples; material didáctico', term:3, displayOrder:3 },
  ...
  // ─── 6ª Classe — Educação Visual ──────────────────────────
  // Unidades 1, 2, 4 e 6 do índice oficial de "Educação Visual e Ofícios — Livro do Aluno,
  // 6ª Classe" (4ª Edição/2025), MEC/IEDA — ieda.gov.mz/site/wp-content/uploads/2020/10/03-Visual-e-Officio-6a_assinado.pdf
  { id:'mz6ev-1', subjectId:'mz6-ev', title:'Desenho e Pintura',        description:'Composição; materiais para o desenho; desenho livre, de observação e com tema dado; ilustração de temas de outras disciplinas; simbologia da cor; círculo cromático; técnicas de pintura — a lápis de cor, a lápis de cera, a caneta de feltro, a guaches e a aguarelas; pintura com tintas artesanais; painéis colectivos', term:1, displayOrder:1 },
  { id:'mz6ev-2', subjectId:'mz6-ev', title:'Impressão, Estampagem, Recorte, Picotagem, Dobragem e Colagem', description:'Técnicas de impressão e estampagem; impressão digital; estampagem com carimbos; monotipia; estampagem com matriz recortada; recorte, picotagem, dobragem e colagem; colagem com elementos vegetais; mosaico', term:1, displayOrder:2 },
  { id:'mz6ev-3', subjectId:'mz6-ev', title:'Desenho Geométrico',       description:'Formato de papel (A5, A4, A3) e graduações do lápis (H1, HB, B1); rectas paralelas e perpendiculares; divisão do segmento de recta em partes iguais; medição e transporte de ângulos; polígonos — hexágono e octógono; construção de espirais bicêntrica e tricêntrica; composições geométricas e acabamento', term:2, displayOrder:3 },
  { id:'mz6ev-4', subjectId:'mz6-ev', title:'Cartaz e Banda Desenhada', description:'Tipos e elementos do cartaz; como elaborar um cartaz; postais, logótipos e convites; conceito e elementos da banda desenhada; onomatopeias', term:3, displayOrder:4 },

  // ─── 6ª Classe — Ofícios ───────────────────────────────────
  // Unidades 3, 5, 7 e 8 do mesmo índice oficial (6ª Classe, Educação Visual e Ofícios).
  // Nota: "Educação Musical" não existe como disciplina autónoma no currículo primário
  // moçambicano actual (PCEP 2020) — mz6-em fica sem capítulos.
  { id:'mz6of-1', subjectId:'mz6-of', title:'Modelagem e Moldagem',     description:'Materiais moldáveis (gesso e borracha de silicone) e respectivas ferramentas; modelagem de diferentes objectos; produção de mosaicos pela técnica da placa; moldes e produção em série; tipos de cozedura; técnica de transformação do papel; decoração, acabamento e maquete', term:2, displayOrder:1 },
  { id:'mz6of-2', subjectId:'mz6-of', title:'Têxteis',                  description:'Tipos de materiais têxteis; tecelagem; fibras naturais, artificiais e recicláveis; teares e tear de cartão; patchwork; pontos de costura', term:2, displayOrder:2 },
  { id:'mz6of-3', subjectId:'mz6-of', title:'Construções',              description:'Técnicas de reutilização de metais e madeira; abelhas e joaninhas feitas com cápsulas de refrigerantes; árvore e bonecos de arame; recuperação de objectos de madeira (lixar, encerar e aplainar)', term:3, displayOrder:3 },
  { id:'mz6of-4', subjectId:'mz6-of', title:'Culinária',                description:'Pesquisa de receitas; utensílios para medição de ingredientes e para cozinhar; confecção de alimentos; salada fria de atum, biscoitos de limão, bolo simples e mini pizza margarita', term:3, displayOrder:4 },

  // ─── 7ª Classe — Língua Portuguesa ────────────────────────
  // Unidades I-XV confirmadas pelo índice oficial da "Ficha de Apoio à Aprendizagem de Língua
  // Portuguesa, 7ª Classe" (MINEDH/INDE, Novembro 2022) — 5 tipos de texto repetidos e
  // aprofundados em cada um dos 3 trimestres
  { id:'mz7port-1',  subjectId:'mz7-port', title:'Textos Normativos (1)',      description:'Regulamento Escolar: estrutura do texto e tipo de linguagem; Tipos de sujeito — sujeito simples e composto; Classe de palavras — preposições (a, de, com)', term:1, displayOrder:1 },
  { id:'mz7port-2',  subjectId:'mz7-port', title:'Textos Administrativos (1)', description:'Aviso: estrutura e tipo de linguagem; Particípio passado dos verbos avisar e informar; Voz passiva com "se" e com "ser"', term:1, displayOrder:2 },
  { id:'mz7port-3',  subjectId:'mz7-port', title:'Textos Jornalísticos (1)',   description:'Notícia: estrutura e tipo de linguagem; Formas de frase — activa e passiva; Complementos circunstanciais de tempo, lugar, causa e fim', term:1, displayOrder:3 },
  { id:'mz7port-4',  subjectId:'mz7-port', title:'Textos Multiuso (1)',        description:'Manuais escolares: estrutura e tipo de linguagem; Classes de palavras — pronomes demonstrativos e possessivos, pronomes interrogativos, pronomes indefinidos (variáveis e invariáveis)', term:1, displayOrder:4 },
  { id:'mz7port-5',  subjectId:'mz7-port', title:'Textos Literários (1)',      description:'Conto e fábula: estrutura e tipo de linguagem; Flexão de adjectivos', term:1, displayOrder:5 },
  { id:'mz7port-6',  subjectId:'mz7-port', title:'Textos Normativos (2)',      description:'Regulamento Escolar (continuação); Formação de palavras — composição por aglutinação e por justaposição; Advérbios de modo — bem, mal, melhor, pior', term:2, displayOrder:6 },
  { id:'mz7port-7',  subjectId:'mz7-port', title:'Textos Administrativos (2)', description:'Declaração: estrutura e tipo de linguagem; Tempos verbais do modo indicativo dos verbos declarar, remeter e emitir; Verbos irregulares — ir, ser, pôr', term:2, displayOrder:7 },
  { id:'mz7port-8',  subjectId:'mz7-port', title:'Textos Jornalísticos (2)',   description:'Fait divers: estrutura e tipo de linguagem; Conjunções e locuções coordenativas e orações coordenadas — copulativas, adversativas e conclusivas', term:2, displayOrder:8 },
  { id:'mz7port-9',  subjectId:'mz7-port', title:'Textos Multiuso (2)',        description:'Instruções técnicas em folhetos de medicamentos: estrutura e tipo de linguagem; Concordância do adjectivo com o nome em género e número; Modos verbais — indicativo, imperativo (afirmativo e negativo) e conjuntivo', term:2, displayOrder:9 },
  { id:'mz7port-10', subjectId:'mz7-port', title:'Textos Literários (2)',      description:'Texto poético: estrutura; Classificação das estrofes quanto ao número de versos e recursos estilísticos; Palavras homónimas e parónimas; Palavras derivadas por prefixação e sufixação', term:2, displayOrder:10 },
  { id:'mz7port-11', subjectId:'mz7-port', title:'Textos Normativos (3)',      description:'Regulamento Escolar (continuação); Formas de tratamento da 2ª/3ª pessoa gramatical', term:3, displayOrder:11 },
  { id:'mz7port-12', subjectId:'mz7-port', title:'Textos Administrativos (3)', description:'Declaração (revisão); Tempos verbais do modo indicativo dos verbos declarar, remeter e emitir (revisão); Verbos irregulares — ir, ser, pôr (revisão)', term:3, displayOrder:12 },
  { id:'mz7port-13', subjectId:'mz7-port', title:'Textos Jornalísticos (3)',   description:'Notícia (revisão); Formas de frase; Discurso directo e indirecto', term:3, displayOrder:13 },
  { id:'mz7port-14', subjectId:'mz7-port', title:'Textos Multiuso (3)',        description:'Instruções técnicas em folhetos de aparelhos; Modos verbais — indicativo, imperativo (afirmativo e negativo) e conjuntivo (revisão)', term:3, displayOrder:14 },
  { id:'mz7port-15', subjectId:'mz7-port', title:'Textos Literários (3)',      description:'Texto dramático: estrutura e tipo de linguagem; Discurso directo e indirecto', term:3, displayOrder:15 },

  // ─── 7ª Classe — Matemática ───────────────────────────────
  // Unidades 1-11 confirmadas pelo índice e pela secção de soluções da "Ficha de Apoio à
  // Aprendizagem de Matemática, 7ª Classe" (MINEDH/INDE, 2022); a fonte não rotula
  // trimestres — distribuição 4/4/3 é uma divisão equilibrada, não citada do documento
  { id:'mz7mat-1',  subjectId:'mz7-mat', title:'Introdução à Teoria de Conjuntos',      description:'Noção de conjunto e elemento; Designação e representação de um conjunto; Relação de pertença e não pertença; Conjunto singular e conjunto vazio; Noção de subconjunto; Noção de reunião e intersecção de dois conjuntos', term:1, displayOrder:1 },
  { id:'mz7mat-2',  subjectId:'mz7-mat', title:'Conjunto dos Números Inteiros',         description:'Conjunto dos números naturais; Noção de número negativo a partir da impossibilidade da subtracção em N; Números inteiros relativos; Módulo ou valor absoluto de um número inteiro; Números simétricos; Operações em Z', term:1, displayOrder:2 },
  { id:'mz7mat-3',  subjectId:'mz7-mat', title:'Introdução à Geometria Plana e Espacial', description:'Ângulos; Polígonos; Triângulos; Circunferência e círculo; Sólidos geométricos', term:1, displayOrder:3 },
  { id:'mz7mat-4',  subjectId:'mz7-mat', title:'Números Racionais: Fracções e Decimais', description:'Surgimento do número fraccionário; Tipos de fracções; Representação de uma fracção na forma mista ou de um número misto; Fracções equivalentes; Fracções irredutíveis; Redução de fracções a um denominador comum; Representação decimal da fracção; Aproximações e arredondamentos de números decimais; Adição e subtracção de números fraccionários e decimais; Multiplicação e divisão de fracções e números decimais; Potência de base fraccionária ou decimal de expoente natural', term:1, displayOrder:4 },
  { id:'mz7mat-5',  subjectId:'mz7-mat', title:'Grandezas e Medidas',                   description:'Perímetro e área de figuras planas; Área e volume de sólidos geométricos — pirâmide, cone e esfera', term:2, displayOrder:5 },
  { id:'mz7mat-6',  subjectId:'mz7-mat', title:'Equações',                              description:'Noção de variável; Conceito de equação e termos de uma equação; Solução de uma equação; Equações equivalentes; Princípios de equivalência de duas equações; Resolução de equações lineares; Resolução de problemas conducentes a equações lineares; Equações literais', term:2, displayOrder:6 },
  { id:'mz7mat-7',  subjectId:'mz7-mat', title:'Percentagens',                          description:'Transformação de percentagem em números fraccionários e decimais; Cálculo de percentagens de quantidades', term:2, displayOrder:7 },
  { id:'mz7mat-8',  subjectId:'mz7-mat', title:'Percentagens: Aplicações Financeiras',  description:'Cálculo do aumento e da diminuição percentual; Desconto; Imposto; Juros; Saldo; Lucro; Prejuízo', term:2, displayOrder:8 },
  { id:'mz7mat-9',  subjectId:'mz7-mat', title:'Razões e Proporções',                   description:'Noção de razão e valor da razão; Escala', term:3, displayOrder:9 },
  { id:'mz7mat-10', subjectId:'mz7-mat', title:'Plano Cartesiano',                      description:'O plano cartesiano; Representação e localização de pontos no plano cartesiano', term:3, displayOrder:10 },
  { id:'mz7mat-11', subjectId:'mz7-mat', title:'Proporcionalidade',                     description:'Proporcionalidade directa; Proporcionalidade inversa', term:3, displayOrder:11 },

  // ─── 7ª Classe — Ciências Sociais ─────────────────────────
  // Capítulos 1,3,5,7 = índice oficial de "Geografia, 7ª Classe – Ficha de Apoio à
  // Aprendizagem" (MINEDH/INDE, Dez. 2022); capítulos 2,4,6,8 = índice oficial de
  // "História, 7ª Classe – Ficha de Apoio à Aprendizagem" (MINEDH/INDE, 2022).
  // Nenhuma das fichas rotula trimestres — a intercalação e distribuição por trimestre
  // é editorial, não citada das fontes
  { id:'mz7cs-1', subjectId:'mz7-cs', title:'Introdução ao Estudo de Geografia',        description:'Conceito, objecto de estudo e métodos da Geografia; Importância do estudo de Geografia; Ramos da Geografia; A Geografia e outras ciências', term:1, displayOrder:1 },
  { id:'mz7cs-2', subjectId:'mz7-cs', title:'A História como Ciência',                  description:'Definição e importância da História; Fontes da História e tipos de fontes; Locais de interesse histórico; Relação entre a História e outras ciências; O tempo em História e sua contagem; Periodização da História de África e de Moçambique', term:1, displayOrder:2 },
  { id:'mz7cs-3', subjectId:'mz7-cs', title:'Representação da Terra',                   description:'Coordenadas geográficas; Principais formas de representação da Terra; Mapas geográficos; Paisagens geográficas', term:1, displayOrder:3 },
  { id:'mz7cs-4', subjectId:'mz7-cs', title:'Origem e Evolução do Homem',               description:'Tentativas de explicar a origem e evolução do Homem; A teoria da criação ou religiosa; África — berço da Humanidade; O processo de hominização e as suas etapas; A conquista do fogo; Organização social dos homens na comunidade primitiva; Primeiras manifestações religiosas e artísticas em África', term:2, displayOrder:4 },
  { id:'mz7cs-5', subjectId:'mz7-cs', title:'A Terra no Universo',                      description:'Conceito, origem e evolução do Universo; Importância do estudo do Universo; Elementos do Universo; O sistema solar — Sol e planetas; A Terra no Universo e os seus movimentos', term:2, displayOrder:5 },
  { id:'mz7cs-6', subjectId:'mz7-cs', title:'O Surgimento da Agricultura e a Formação dos Primeiros Estados no Mundo e em África', description:'Início da agricultura e da domesticação de animais; Divisão social do trabalho e primeiras sociedades de classes; O Egipto Antigo; A Mesopotâmia e a Babilónia — o Código de Hamurabi; A Grécia Antiga e as cidades-estado; A Roma Antiga', term:2, displayOrder:6 },
  { id:'mz7cs-7', subjectId:'mz7-cs', title:'A Terra e as suas Esferas',                description:'Introdução ao estudo das esferas da Terra; A atmosfera e a sua composição; Hidrosfera — caracterização e importância; Litosfera', term:3, displayOrder:7 },
  { id:'mz7cs-8', subjectId:'mz7-cs', title:'Reinos e Impérios Africanos (Séc. IX–XVII); Moçambique — da Comunidade Primitiva à Formação dos Primeiros Estados', description:'As comunidades Khoisan; Os povos de língua Bantu — expansão e fixação; O Reino do Zimbabwe; O Império de Mutapa (Mwenemutapa); Os Impérios do Ghana, Mali e Songhai', term:3, displayOrder:8 },

  // ─── 7ª Classe — Ciências Naturais ────────────────────────
  // APENAS o 1º trimestre está confirmado, por uma fonte de 2021 (Plano Analítico de Ciências
  // Naturais, 7ª Classe, 1º Trimestre — Escola Primária Completa do 1º e 2º Grau de Mangala,
  // Moçambique). O 2º/3º trimestre não foram encontrados em fonte fiável — a ficha MINEDH 2022
  // mais recente para esta área cobre "Biologia" separadamente e tinha um PDF ilegível
  // (codificação de fonte corrompida); pode estar desactualizado — a confirmar.
  { id:'mz7cn-1', subjectId:'mz7-cn', title:'Saúde e Sistemas do Corpo Humano',       description:'Saúde; Sistema circulatório; Sistema urinário', term:1, displayOrder:1 },
  { id:'mz7cn-2', subjectId:'mz7-cn', title:'Água e Conservação dos Recursos Naturais', description:'Água; Conservação do solo; Caça e pesca', term:1, displayOrder:2 },

  // ─── 7ª Classe — Educação Visual ──────────────────────────
  // Unidades 1-5 confirmadas pelo Programa de Ensino da Disciplina de Educação Visual —
  // Ensino Secundário, 1º Ciclo (INDE/MINEDH, Setembro de 2024), Tabela das Unidades Temáticas - 7ª Classe.
  // Nota: "Ofícios" e "Educação Musical" não constam da lista oficial de disciplinas da
  // 7ª classe no currículo revisto de 2024 — mz7-of e mz7-em ficam sem capítulos.
  { id:'mz7ev-1', subjectId:'mz7-ev', title:'Introdução ao Estudo da Arte',            description:'Definição e importância da arte no desenvolvimento integral do ser humano; formas de expressão artística; formas de expressão artística moçambicanas e da comunidade — arquitectura, escultura, pintura, cerâmica; classificação das formas de expressão artística; artistas moçambicanos — Malangatana, Chichorro, Samate Mulungo, Naguib, Alberto Chissano, Ntaluma, Reinata Sadimba, José Forjaz', term:1, displayOrder:1 },
  { id:'mz7ev-2', subjectId:'mz7-ev', title:'Suportes e Materiais',                    description:'Caderno de esboços — selecção de materiais, produção e acabamentos; godê de material reciclável; quadro de cartão/papelão; quadro em relevo', term:1, displayOrder:2 },
  { id:'mz7ev-3', subjectId:'mz7-ev', title:'Materiais e Técnicas de Expressão Gráfica', description:'Materiais de expressão gráfica — suportes e riscadores; técnicas de desenho e pintura — observação, pintura soprada, pontilhismo, desenho à linha; técnica mista com materiais naturais e recicláveis; painéis colectivos', term:2, displayOrder:3 },
  { id:'mz7ev-4', subjectId:'mz7-ev', title:'Comunicação Visual',                      description:'Definição, importância e agentes da comunicação visual; códigos visuais — sinais, símbolos e ícones; tipos de cartazes; banda desenhada; cartazes e banda desenhada sobre temas transversais — igualdade de género, direitos das crianças e jovens, poupança e seguros', term:2, displayOrder:4 },
  { id:'mz7ev-5', subjectId:'mz7-ev', title:'Desenho Geométrico',                      description:'Importância do desenho geométrico; normalização — esquadria, legenda, letras e algarismos', term:3, displayOrder:5 },

  // ─── 7ª Classe — Língua Inglesa ────────────────────────────
  // Unidades 1-9 e distribuição trimestral confirmadas pelo Programa de Ensino da Disciplina de
  // Língua Inglesa — Ensino Secundário, 1º Ciclo (INDE/MINEDH, Setembro de 2024), Syllabus - Grade 7
  { id:'mz7ing-1', subjectId:'mz7-ing', title:'Greetings and Introductions',        description:'Alfabeto inglês; apresentação pessoal; cumprimentos formais e informais; números de 0 a 20; países e nacionalidades; verbo to be (afirmativa, interrogativa e negativa); pronomes pessoais e possessivos; artigos', term:1, displayOrder:1 },
  { id:'mz7ing-2', subjectId:'mz7-ing', title:'School',                             description:'Localização de espaços na escola; horas e dias da semana; horário escolar; números até 100; ordens e instruções na sala de aula; ambiente saudável na escola; imperativo; there is/are; presente simples', term:1, displayOrder:2 },
  { id:'mz7ing-3', subjectId:'mz7-ing', title:'The Family and Friends',             description:'Árvore genealógica — família nuclear e alargada; roupas e cores; presente simples; caso possessivo; adjectivos; verbo to have got; quantificadores some/any', term:1, displayOrder:3 },
  { id:'mz7ing-4', subjectId:'mz7-ing', title:'The Human Body — Health and Nutrition', description:'Partes do corpo; hábitos de higiene; alimentos saudáveis e não saudáveis; gostos e preferências; imperativo; marcadores de sequência; passado simples (verbos irregulares); presente contínuo', term:2, displayOrder:4 },
  { id:'mz7ing-5', subjectId:'mz7-ing', title:'The Home and Community',             description:'Tipos de casas; divisões e mobiliário; objectos domésticos comuns; actividades diárias em casa; lugares públicos na comunidade; preposições de lugar; quantificadores; passado contínuo; verbos modais can/may', term:2, displayOrder:5 },
  { id:'mz7ing-6', subjectId:'mz7-ing', title:'The Environment',                    description:'Elementos do ambiente; preservação e protecção ambiental; participação dos jovens em causas ambientais; meses do ano, tempo e estações; conectores; futuro simples will; primeiro condicional; verbos modais de sugestão e probabilidade', term:2, displayOrder:6 },
  { id:'mz7ing-7', subjectId:'mz7-ing', title:'Aquatic Life',                       description:'Importância da vida aquática; instrumentos de pesca; pesca artesanal e industrial; efeitos nocivos da pesca e da poluição industrial; futuro going to; presente perfeito; nomes compostos; verbos modais must/mustn\'t', term:3, displayOrder:7 },
  { id:'mz7ing-8', subjectId:'mz7-ing', title:'Transport and Communication',        description:'Meios de transporte e de comunicação; tipos de seguro; profissões ligadas ao transporte; distância e tempo de viagem; tipos de estradas; principais pontes de Moçambique; regras de segurança rodoviária; futuro simples; passado perfeito; voz passiva no presente', term:3, displayOrder:8 },
  { id:'mz7ing-9', subjectId:'mz7-ing', title:'Entertainment and Sports',          description:'Actividades de lazer; preferências desportivas e de entretenimento entre pais e adolescentes; desportistas moçambicanos; adjectivos comparativos; passado simples e presente simples', term:3, displayOrder:9 },
  ...
  // ─── Língua Portuguesa 11ª Classe ───────────────────────────
  // Fonte: INDE/MINED — Português, Programa da 11ª Classe (Programa oficial ESG2, 2010), 9. Plano Temático (Unidades Temáticas I-XVIII)
  { id:'mz11port-1', subjectId:'mz11-port', title:'Textos Normativos, Administrativos e Jornalísticos (I)', description:'Lei da Família (Título I — disposições gerais ao artigo 140.º); diminutivos eruditos da derivação sufixal; a Procuração; conjunções/locuções subordinativas concessivas; a Reportagem; regência do complemento indirecto pela preposição "a"; complementos de verbos de movimento', term:1, displayOrder:1 },
  { id:'mz11port-2', subjectId:'mz11-port', title:'Textos Multiusos, Literários e de Pesquisa de Dados (I)', description:'Texto expositivo-explicativo; concordância verbal em orações subordinadas sem sujeito expresso, com sujeito posposto e verbos impessoais; Oratura vs Literatura, textos narrativos da oratura moçambicana (conto tradicional, fábula, lenda, mito); figuras de estilo (interrogação, hipérbole, elipse, pleonasmo); referência bibliográfica; conector "pois"; quantificadores tudo, todo e ninguém', term:1, displayOrder:2 },
  { id:'mz11port-3', subjectId:'mz11-port', title:'Textos Normativos, Administrativos e Jornalísticos (II)', description:'Lei da Família (Subsecção II, artigo 141.º ao artigo 279.º); derivação parassintética; a Exposição; conjunções/locuções subordinativas condicionais; a Crónica da actualidade (descritiva, narrativa, dissertativa, narrativo-descritiva, humorística); evolução do português europeu e do português de Moçambique', term:2, displayOrder:3 },
  { id:'mz11port-4', subjectId:'mz11-port', title:'Textos Multiusos, Literários e de Pesquisa de Dados (II)', description:'Texto expositivo-argumentativo; verbos impessoais (haver, tratar-se de, bastar que); texto lírico — canção tradicional, poesia de Camões, Almeida Garrett e Fernando Pessoa, poesia de Rui de Noronha, Noémia de Sousa e José Craveirinha, poesia de combate; figuras de estilo (apóstrofe, prosopopeia, anáfora, anástrofe); o resumo e a ficha de leitura; quantificadores em orações comparativas e consecutivas', term:2, displayOrder:4 },
  { id:'mz11port-5', subjectId:'mz11-port', title:'Textos Normativos, Administrativos e Jornalísticos (III)', description:'Lei da Família (Capítulo II, artigo 280.º ao artigo 431.º); diminutivos eruditos e derivação parassintética; Procuração e Exposição; conjunções/locuções subordinativas finais; Reportagem e Crónica — categorias da narração e da descrição; regência verbal pela preposição "a" e complementos de verbos de movimento; evolução linguística da Língua Portuguesa', term:3, displayOrder:5 },
  { id:'mz11port-6', subjectId:'mz11-port', title:'Textos Multiusos, Literários e de Pesquisa de Dados (III)', description:'Texto expositivo-explicativo e expositivo-argumentativo; orações subordinadas sem sujeito expresso e verbos impessoais; Literatura vs Oratura, textos narrativos com valores culturais moçambicanos; resumo, ficha de leitura e referências bibliográficas; conector "pois" e quantificadores em orações comparativas e consecutivas', term:3, displayOrder:6 },

  // ─── Química 11ª Classe ──────────────────────────────────────
  // Fonte: INDE/MINED — Química, Programa da 11ª Classe (Programa oficial ESG2, 2010), 8. Visão geral dos conteúdos da 11ª Classe
  { id:'mz11qui-1', subjectId:'mz11-qui', title:'Conceitos Fundamentais', description:'A Química como ciência e o método científico; propriedades das substâncias (específicas, funcionais e gerais); classificação da matéria — mistura e substância pura (elementar simples e composta); métodos de separação de misturas (destilação, cromatografia, dissolução fraccionada, separação magnética, centrifugação, cristalização e liquefacção fraccionadas, sedimentação, levigação); classificação das reacções químicas; cálculos estequiométricos — massa molecular relativa, mole e massa molar, Lei de Avogadro, Lei de Lavoisier e de Proust', term:1, displayOrder:1 },
  { id:'mz11qui-2', subjectId:'mz11-qui', title:'Estrutura Atómica', description:'Radioactividade e ensaio de Rutherford; postulados de Bohr; partículas fundamentais do átomo; número atómico e número de massa; isótopos, isóbaros e isótonos; mecânica quântica — níveis e subníveis de energia (Diagrama de Pauling e Regra de Hund), números quânticos; relação entre estrutura electrónica e propriedades químicas dos elementos', term:1, displayOrder:2 },
  { id:'mz11qui-3', subjectId:'mz11-qui', title:'Tabela Periódica', description:'Lei Periódica de Mendeleev e características da Tabela Periódica moderna; propriedades periódicas — raio atómico e iónico, energia de ionização, electronegatividade, afinidade electrónica; relação entre a estrutura de valência dos elementos e os gases nobres; relação entre estrutura atómica e Tabela Periódica', term:2, displayOrder:3 },
  { id:'mz11qui-4', subjectId:'mz11-qui', title:'Ligação Química', description:'Definição e tipos de ligação, estrutura de Lewis; ligação covalente (polar, apolar e dativa), rede molecular e atómica, polaridade e forças intermoleculares; ligação metálica — propriedades, fenómenos de forja e soldadura, metais importantes da indústria moçambicana (Al, Fe, Zn, Au, Ag, Cu) e ligas metálicas', term:2, displayOrder:4 },
  { id:'mz11qui-5', subjectId:'mz11-qui', title:'Classes Principais dos Compostos Inorgânicos', description:'Óxidos — definição, classificação e obtenção; Ácidos — teoria de dissociação electrolítica de Arrhenius, classificação e obtenção laboratorial e industrial do H2SO4, HCl e HNO3; Bases — hidróxidos, obtenção industrial do NaOH e Ca(OH)2, reacção de neutralização; Sais — classificação, solubilidade e ocorrência na natureza', term:2, displayOrder:5 },
  { id:'mz11qui-6', subjectId:'mz11-qui', title:'Soluções', description:'Tipos de soluções e seus componentes; soluções diluídas, concentradas, saturadas e sobressaturadas; tipos de concentração (comum, densidade, percentual, molar, normal); cálculos de diluição e mistura de soluções', term:3, displayOrder:6 },
  { id:'mz11qui-7', subjectId:'mz11-qui', title:'Termoquímica', description:'Conceitos de energia, trabalho, calor, temperatura e entalpia; reacções endotérmicas e exotérmicas, equação termoquímica; diagramas de entalpia e Lei de Hess; tipos de entalpia — formação, decomposição, combustão, ligação e dissociação', term:3, displayOrder:7 },

  // ─── Biologia 11ª Classe ─────────────────────────────────────
  // Fonte: INDE/MINEDH — O meu caderno de actividades de Biologia, 11ª Classe (Direcção Nacional do Ensino Secundário), Unidades Temáticas I-III
  { id:'mz11bio-1', subjectId:'mz11-bio', title:'Sistema de Classificação dos Seres Vivos', description:'Breve historial dos sistemas de classificação dos seres vivos (Lineu, Haeckel, Copeland, Whittaker) e sua evolução; regras de nomenclatura binomial e hierarquia das categorias taxonómicas — espécie, género, família, ordem, classe, filo e reino', term:1, displayOrder:1 },
  { id:'mz11bio-2', subjectId:'mz11-bio', title:'Estudo e Classificação dos Seres Vivos do Reino Monera ao Plantae', description:'Reino Monera — seres procarióticos (Filo Bactérias e Filo Cyanophyta); Vírus; Reino Protista — seres eucariontes (Filo dos Protozoários); Reino dos Fungos; Reino Plantae ou Reino Vegetal — Filo Briófita e Filo Traqueófita, gimnospermas e angiospermas', term:2, displayOrder:2 },
  { id:'mz11bio-3', subjectId:'mz11-bio', title:'Estudo e Classificação dos Seres Vivos do Reino Animal', description:'Animais acelomados (Filo Espongiários, Filo Celenterados ou Cnidários, Filo Platelmintes); animais pseudocelomados (Filo Nematelmintes); animais celomados (Filo Anelídeos, Filo Artrópodes, Filo Moluscos, Filo Equinodermes, Filo Cordados)', term:3, displayOrder:3 },

  // ─── Geografia 11ª Classe ────────────────────────────────────
  // Fonte: INDE/MINEDH — Geografia, 11ª Classe, O meu caderno de actividades (Direcção Nacional de Ensino Secundário), Unidades Didácticas 1-6
  { id:'mz11geo-1', subjectId:'mz11-geo', title:'Introdução ao Pensamento Geográfico', description:'Conceitos principais e divisões da Geografia (física e humana); posição da Geografia no contexto das ciências; importância e aplicação da Geografia; métodos geográficos; evolução do pensamento geográfico desde a Antiguidade Greco-Romana até à actualidade; grandes correntes geográficas', term:1, displayOrder:1 },
  { id:'mz11geo-2', subjectId:'mz11-geo', title:'Cosmografia', description:'Conceito de Cosmografia; o sistema solar; a Terra e os seus movimentos — rotação e translação', term:1, displayOrder:2 },
  { id:'mz11geo-3', subjectId:'mz11-geo', title:'Ambiente Bioclimático', description:'Conceito de ambiente bioclimático; estrutura e composição da atmosfera; equilíbrio térmico da Terra e pressão atmosférica; tempo e clima — classificação e tipos de clima; formações vegetais de Moçambique', term:2, displayOrder:3 },
  { id:'mz11geo-4', subjectId:'mz11-geo', title:'Geomorfologia', description:'Conceito de Geologia e Geomorfologia; litosfera; migração dos continentes; agentes modeladores do relevo; tipos de rochas — magmática, sedimentar detrítica, sedimentar quimiogénica, sedimentar biogénica e metamórfica', term:2, displayOrder:4 },
  { id:'mz11geo-5', subjectId:'mz11-geo', title:'Pedogeografia', description:'Conceito de Pedogeografia; processos e factores de formação do solo; classificação dos solos (zonais, intrazonais e azonais) e sua importância', term:3, displayOrder:5 },
  { id:'mz11geo-6', subjectId:'mz11-geo', title:'Hidrogeografia', description:'Conceito de Hidrogeografia; rios e águas subterrâneas; lagos; oceanos e mares', term:3, displayOrder:6 },

  // ─── História 11ª Classe ─────────────────────────────────────
  // Fonte: INDE/MINEDH — História, 11ª Classe, O meu caderno de actividades (Direcção Nacional do Ensino Secundário), Unidades Didácticas 1-5
  { id:'mz11his-1', subjectId:'mz11-his', title:'Historiografia', description:'Conceito de História e de Historiografia; evolução da historiografia desde a Antiguidade Oriental e Clássica até ao século XX; correntes historiográficas e principais autores (Heródoto, Tucídides, Políbio, Tito Lívio, Tácito, Santo Agostinho, Fernão Lopes, entre outros)', term:1, displayOrder:1 },
  { id:'mz11his-2', subjectId:'mz11-his', title:'A Invasão do Continente Africano', description:'África diante do desafio colonial; a corrida imperialista e a partilha de África — Conferência de Berlim, partilha de África, conquista militar e evolução do mapa político africano; a resistência africana — generalização, ideologia e consequências', term:1, displayOrder:2 },
  { id:'mz11his-3', subjectId:'mz11-his', title:'O Período Colonial', description:'A política indígena; formas de dominação colonial; estruturas coloniais — aparelho político-administrativo, territórios franceses e territórios britânicos; economia colonial — características gerais, principais actividades e impacto do colonialismo em África', term:2, displayOrder:3 },
  { id:'mz11his-4', subjectId:'mz11-his', title:'O Nacionalismo Africano', description:'Surgimento do nacionalismo em África; o percurso para a independência nas colónias inglesas da África Ocidental (Gana/Costa do Ouro); o caminho para a independência nos territórios franceses; independência do Congo; independência na África Central Britânica', term:3, displayOrder:4 },
  { id:'mz11his-5', subjectId:'mz11-his', title:'África Independente', description:'Problemas de África no pós-independência; a Organização da Unidade Africana e a passagem da OUA para a União Africana; integração económica na África Austral — a SADCC e a passagem da SADCC para a SADC', term:3, displayOrder:5 },

  // ─── Inglês 11ª Classe ───────────────────────────────────────
  // Fonte: INDE/MINEDH — English, Grade 11 Workbook with practical exercises (DINES), Units 1-15
  { id:'mz11ing-1', subjectId:'mz11-ing', title:'School Subjects', description:'Vocabulário sobre disciplinas escolares e áreas de estudo (Química, Matemática, Geografia, Física, Música, Artes); discussão sobre escolhas vocacionais e o mercado de trabalho', term:1, displayOrder:1 },
  { id:'mz11ing-2', subjectId:'mz11-ing', title:'Relationships', description:'Vocabulário sobre relações familiares e de amizade (friendship, alliance, companionship); o genitivo possessivo (’s) aplicado à árvore genealógica', term:1, displayOrder:2 },
  { id:'mz11ing-3', subjectId:'mz11-ing', title:'Identity', description:'Línguas e grupos culturais de Moçambique; culinária tradicional, fauna e paisagens moçambicanas', term:1, displayOrder:3 },
  { id:'mz11ing-4', subjectId:'mz11-ing', title:'Initiation Rites', description:'Ritos de iniciação nas culturas moçambicanas', term:1, displayOrder:4 },
  { id:'mz11ing-5', subjectId:'mz11-ing', title:'Style', description:'Vocabulário sobre estilo, moda e vestuário (clothes, smartness, dress, fashion)', term:1, displayOrder:5 },
  { id:'mz11ing-6', subjectId:'mz11-ing', title:'Made in Mozambique', description:'Produtos e produção nacional moçambicana — agricultura e indústria', term:2, displayOrder:6 },
  { id:'mz11ing-7', subjectId:'mz11-ing', title:'At the Bank', description:'Vocabulário bancário; políticas monetárias, o Banco de Moçambique e serviços bancários (empréstimos comerciais, depósitos, meios de pagamento)', term:2, displayOrder:7 },
  { id:'mz11ing-8', subjectId:'mz11-ing', title:'Citizenship, Democracy, Politics & Elections', description:'Componentes da cidadania (igualdade, justiça e diversidade) e tipos de cidadania; conceito de democracia e seus pilares; democracia directa e representativa; eleições em Moçambique', term:2, displayOrder:8 },
  { id:'mz11ing-9', subjectId:'mz11-ing', title:'The Coconut Tree', description:'Descrição científica do coqueiro (Cocos nucifera) — estrutura, fruto, raízes e flores', term:3, displayOrder:9 },
  { id:'mz11ing-10', subjectId:'mz11-ing', title:'Droughts and Floods in Mozambique', description:'Secas e cheias em Moçambique; vocabulário sobre desastres naturais e reconstrução', term:3, displayOrder:10 },
  { id:'mz11ing-11', subjectId:'mz11-ing', title:'Bed & Breakfast', description:'Vocabulário turístico e de hotelaria; produção de textos publicitários', term:3, displayOrder:11 },
  { id:'mz11ing-12', subjectId:'mz11-ing', title:'Dressing Codes & Wedding', description:'Códigos de vestuário e tradições do casamento moçambicano', term:3, displayOrder:12 },
  ...
  // ─── Língua Portuguesa 12ª Classe ────────────────────────────
  // "Português, Programa da 12ª Classe" — INDE/MINED - Moçambique (2010),
  // secção 7 "Visão Geral dos Conteúdos da 12ª Classe" (índice oficial por trimestre)
  { id:'mz12port-1', subjectId:'mz12-port', title:'Textos Normativos e Jornalísticos (1º Trimestre)', description:'Lei nº 18/2002 de 10 de Outubro — Recenseamento Eleitoral (Artigos 1 a 18); formação de palavras — derivações irregulares; Artigo de fundo/editorial — justificativa do tema, apresentação da tese, desenvolvimento e síntese, tipo de linguagem opinativo; variação da língua portuguesa no espaço — Brasil e Moçambique; temas transversais — Declaração dos Direitos Humanos e Democracia, Saúde e Nutrição', term:1, displayOrder:1 },
  { id:'mz12port-2', subjectId:'mz12-port', title:'Textos Multiusos, Literários e de Pesquisa de Dados (1º Trimestre)', description:'Texto Expositivo-Argumentativo — apresentação, organização e tipo de linguagem; conjunções/locuções subordinativas e orações subordinadas comparativas; Texto Narrativo — estrutura, categorias da narrativa e tipo de linguagem; concordância do nome predicativo do sujeito; Ficha de leitura — síntese e sumário; orações relativas com os pronomes cujo e onde; temas transversais — desastres naturais (maremotos), combate à estigmatização de pessoas vivendo com HIV/SIDA, biblioteca', term:1, displayOrder:2 },
  { id:'mz12port-3', subjectId:'mz12-port', title:'Textos Normativos e Jornalísticos (2º Trimestre)', description:'Lei nº 19/2002 de 10 de Outubro — Lei Eleitoral, eleições dos órgãos das autarquias locais; formação de palavras — derivações irregulares; divisão ou separação de poderes num Estado de Direito; Artigo de opinião — mancha gráfica, estrutura do texto e tipo de linguagem; regência verbal — complementos de verbos de separação; tema transversal — saneamento do meio', term:2, displayOrder:3 },
  { id:'mz12port-4', subjectId:'mz12-port', title:'Textos Multiusos, Literários e de Pesquisa de Dados (2º Trimestre)', description:'Texto expositivo-explicativo (textos didácticos e/ou científicos) — apresentação, organização e tipo de linguagem; conjunções/locuções subordinativas e orações subordinadas consecutivas; Texto Lírico — caracterização estrutural e temática, tipo de linguagem; figuras de pensamento; Inquérito — organização do texto e tipo de linguagem; orações relativas com os pronomes cujo e onde; temas transversais — desastres naturais (maremotos), combate à estigmatização de pessoas vivendo com HIV/SIDA, biblioteca', term:2, displayOrder:4 },
  { id:'mz12port-5', subjectId:'mz12-port', title:'Textos Normativos e Jornalísticos (3º Trimestre)', description:'Lei nº 19/2002 de 10 de Outubro — Capítulo V (Votação), Artigos 57 a 79; formação de palavras — derivações irregulares; função da polícia num Estado de Direito e Democrático; Artigo de opinião e Artigo de fundo/editorial; regência de orações integrantes; temas transversais — saúde e nutrição, plantio de árvores e saúde pública', term:3, displayOrder:5 },
  { id:'mz12port-6', subjectId:'mz12-port', title:'Textos Multiusos, Literários e de Pesquisa de Dados (3º Trimestre)', description:'Texto expositivo-explicativo e Texto Expositivo-Argumentativo; conjunções/locuções subordinativas e orações subordinadas comparativas e consecutivas; Texto Dramático e o Teatro Contemporâneo em Moçambique — o ritual na génese do modo dramático (Nyao, Mapico), caracterização do modo dramático; figuras de sintaxe; Ficha de leitura; orações relativas e orações integrantes; temas transversais — desastres naturais (maremotos), combate à estigmatização de pessoas vivendo com HIV/SIDA, biblioteca', term:3, displayOrder:6 },

  // ─── Química 12ª Classe ───────────────────────────────────────
  // "Química, Programa da 12ª Classe" — INDE/MINED - Moçambique (2010),
  // secção 8 "Visão geral dos conteúdos da 12ª Classe" (5 unidades temáticas por trimestre)
  { id:'mz12qui-1', subjectId:'mz12-qui', title:'Cinética Química', description:'Conceito de cinética química, reacções rápidas e lentas; teoria de colisões, complexo activado e energia de activação; factores que afectam a velocidade de uma reacção — natureza dos reagentes, concentração, temperatura, superfície de contacto e catalisador; velocidade média e instantânea; lei de velocidade e ordem da reacção; mecanismo de reacção; lei da velocidade para reacções elementares e não elementares', term:1, displayOrder:1 },
  { id:'mz12qui-2', subjectId:'mz12-qui', title:'Equilíbrio Químico', description:'Reacções irreversíveis e reversíveis; características do estado de equilíbrio; factores que afectam o equilíbrio — concentração, pressão e temperatura; princípio de Le Chatelier; posição do equilíbrio e espontaneidade da reacção; constante de equilíbrio em função das concentrações (Kc) e das pressões parciais (Kp); cálculos envolvendo Kc e Kp', term:1, displayOrder:2 },
  { id:'mz12qui-3', subjectId:'mz12-qui', title:'Equilíbrio Ácido-Base em Solução Aquosa', description:'Conceito histórico de ácido e base; teoria de Bronsted-Lowry — ião hidrónio, reacção protolítica e pares conjugados ácido/base; forças de ácidos e bases — constantes Ka e Kb; equilíbrio iónico da água (Kw) e relação entre Ka, Kb e Kw; grau de ionização e Lei da Diluição de Ostwald; escala de pH e pOH; cálculo de pH de ácidos e bases fortes e fracos; hidrólise de sais; soluções tampão — preparação, cálculo de pH, fórmula e razão tampão; indicadores ácido-base — ponto de equivalência e zona de viragem; importância dos sistemas tampão na natureza, no organismo e na indústria', term:1, displayOrder:3 },
  { id:'mz12qui-4', subjectId:'mz12-qui', title:'Solubilidade e Titulação Ácido-Base', description:'Solubilidade (S) e produto de solubilidade (Ks ou Kps); titulação de ácido forte com base forte; ponto de equivalência e respectivos cálculos; experiência química de titulação ácido-base (HCl e NaOH)', term:2, displayOrder:4 },
  { id:'mz12qui-5', subjectId:'mz12-qui', title:'Reacções Redox e Electroquímica', description:'Conceito histórico de oxidação e redução — agente redutor e agente oxidante, número de oxidação e regras de determinação; pares conjugados redox e semi-equações redox; acerto de equações redox pelo método da variação do número de oxidação e método ião-electrão; célula galvânica e pilha de Daniell; tipos de eléctrodos e eléctrodo normal de hidrogénio; força electromotriz (f.e.m.) e potencial normal; bateria de chumbo e pilha seca; electrólise de soluções aquosas e de substâncias iónicas fundidas; leis de Faraday; aplicações da electrólise — galvanoplastia, galvanostegia, anodização e refinação de metais', term:2, displayOrder:5 },
  { id:'mz12qui-6', subjectId:'mz12-qui', title:'Química Orgânica — Funções Orgânicas e Biomoléculas', description:'Revisão de hidrocarbonetos — fórmula geral, nomenclatura usual e IUPAC, reacções de substituição e adição; álcoois e fenóis — preparação, propriedades e aplicações, poli-álcoois (etilenoglicol e glicerol); oxidação de álcoois primários e secundários; éteres, aldeídos e cetonas; ácidos carboxílicos e ésteres — esterificação; aminas e amidas; triglicerídeos, ácidos gordos, sabões e detergentes — reacção de saponificação; aminoácidos, ligação peptídica e estrutura primária das proteínas', term:2, displayOrder:6 },
  { id:'mz12qui-7', subjectId:'mz12-qui', title:'Química Orgânica — Carbohidratos e Polímeros Sintéticos', description:'Importância das proteínas no organismo; carbohidratos — monossacarídeos, dissacarídeos e polissacarídeos (amido e celulose) como fonte de energia; polimerização e classificação de polímeros — polímeros de adição (polietileno, poliuretanas, elastómeros) e de condensação (poliamidas, poliésteres, silicone, policarbonato, baquelite); vulcanização da borracha; fibras têxteis — lã, seda, algodão, poliésteres e poliamidas; problemas ambientais causados pelos polímeros sintéticos', term:3, displayOrder:7 },

  // ─── Biologia 12ª Classe ──────────────────────────────────────
  // "Programa de Ensino da Disciplina de Biologia — Ensino Secundário, 2º Ciclo"
  // INDE/MEC - Moçambique, edição 2026 (Maputo, Fevereiro de 2026),
  // secção "Plano Temático da Disciplina de Biologia 12ª Classe"
  { id:'mz12bio-1', subjectId:'mz12-bio', title:'Citologia', description:'Estudo das células procariotas e eucariotas; organelos celulares e suas funções; composição química da célula; tipos de membranas — permeáveis, semi-permeáveis e impermeáveis; protoplasma e colóide, movimentos de Brown; transporte na célula — difusão, osmose e transporte activo; metabolismo celular — catabolismo e anabolismo; enzimas — conceito, mecanismo de acção e factores que influenciam a actividade enzimática; fontes de energia na célula — respiração aeróbica e anaeróbica (fermentação alcoólica, láctica e acética) e sua importância na indústria', term:1, displayOrder:1 },
  { id:'mz12bio-2', subjectId:'mz12-bio', title:'Fisiologia Vegetal', description:'Histologia vegetal — meristemas primários e secundários; tecidos definitivos parenquimatosos, de suporte, vasculares, de revestimento, secretores e glandulares; estrutura primária e secundária da raiz e do caule; circulação da seiva bruta e elaborada — coesão, adesão, pressão radicular, capilaridade e transpiração; estrutura e funcionamento dos estomas; fotossíntese — plastídios (cromoplastos, leucoplastos e cloroplastos), pigmentos fotossintéticos (clorofilas e carotenóides), fase luminosa (fotofosforilação cíclica e acíclica) e fase escura (ciclo de Calvin), equação química e factores que influenciam a actividade fotossintética', term:1, displayOrder:2 },
  { id:'mz12bio-3', subjectId:'mz12-bio', title:'Fisiologia Animal — Sentidos, Sistema Nervoso e Grandes Sistemas', description:'Histologia animal — tecidos epiteliais, conjuntivos, musculares e nervoso; anatomia e fisiologia dos órgãos dos sentidos (olho, ouvido, língua, pele e nariz) e suas principais doenças; sistema nervoso — sistema nervoso central e periférico, estrutura e função do neurónio, impulso nervoso, arco reflexo e acto reflexo, reflexos condicionados e não condicionados, doenças do sistema nervoso; sistema endócrino — glândulas e hormonas; sistema ósseo-muscular — divisão do esqueleto, classificação dos ossos, articulações e tipos de músculos; sistema digestivo — estudo comparativo em invertebrados e vertebrados, digestão no Homem, enzimas digestivas e doenças; sistema respiratório — estudo comparativo, movimentos respiratórios, alvéolos pulmonares e doenças (asma, pneumonia, tuberculose, bronquite, COVID-19)', term:2, displayOrder:3 },
  { id:'mz12bio-4', subjectId:'mz12-bio', title:'Fisiologia Animal — Circulação, Excreção e Reprodução', description:'Sistema circulatório — estudo comparativo em invertebrados e vertebrados, constituição e função do sangue humano, coagulação e doenças (enfarte do miocárdio, arteriosclerose, hiper/hipotensão); sistema linfático — funções, constituição e doenças (elefantíase, edema linfático); sistema excretor — estudo comparativo, excreção de substâncias azotadas, estrutura e funcionamento do rim, doenças (gota, infecção urinária); sistema reprodutor — tipos de reprodução assexuada e sexuada, estudo comparativo em invertebrados, sistema reprodutor masculino e feminino do Homem, ciclo menstrual, fecundação, gravidez precoce, planeamento familiar e métodos anticoncepcionais; ontogénese — fases do desenvolvimento embrionário e anexos embrionários', term:3, displayOrder:4 },
  { id:'mz12bio-5', subjectId:'mz12-bio', title:'Saúde', description:'Vírus — características e reprodução (ciclo lítico e lisogénico); doenças virais — sintomas, modo de transmissão e prevenção do HIV/SIDA, sarampo, varicela, varíola, raiva, ébola e gripe suína e aviária; segurança alimentar — conceito, factores que a ameaçam e formas de a garantir; agricultura sustentável; necessidades nutricionais na adolescência; sinais de desnutrição e obesidade', term:3, displayOrder:5 },
