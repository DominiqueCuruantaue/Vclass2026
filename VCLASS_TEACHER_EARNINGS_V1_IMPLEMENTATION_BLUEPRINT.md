...
All Definition-of-Done rows are now ✅ except the ones explicitly blocked on external prerequisites (VQ-B, CRA full automation pending a payment gateway, refund reversal, UI) — see the updated table above. Fraud foundations closed in Session 6 below.
